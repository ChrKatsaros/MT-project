...
function About() {
  return (
    <>
      ...
      <title>About Mistress Tabitha Thorne | Professional Dominatrix UK</title>

      <meta
        name="description"
        content="Discover Mistress Tabitha Thorne, an experienced professional Dominatrix offering private BDSM experiences in London, Bournemouth, Southampton and Portsmouth."
      />

      <meta name="robots" content="index, follow" />

      <link rel="canonical" href="https://www.tabithathorne.co.uk/about" />

      {/* OPEN GRAPH */}

      <meta
        property="og:title"
        content="About Mistress Tabitha Thorne | Professional Dominatrix UK"
      />

      <meta
        property="og:description"
        content="Discover the approach, presence and philosophy of Mistress Tabitha Thorne, offering private professional domination experiences across London and the South Coast."
      />

      <meta property="og:url" content="https://www.tabithathorne.co.uk/about" />
      ...
      <meta
        ...
        content="Discover the approach, presence and philosophy of Mistress Tabitha Thorne and her private professional domination experiences."
      />
      ...
      <div className="about-page">
        ...
        <section className="about-section">
          ...
          <div className="text-block">
            <p>
              With training in sensual tantric and body-to-body massage,
              alongside a background in counselling and emotional guidance, she
              understands the subtle language of energy, anticipation, touch,
              pacing, and surrender.
            </p>

            <p>
              Experiences are tailored carefully to the individual dynamic and
              are available across London, Bournemouth, Southampton and
              Portsmouth, with carefully selected private venues arranged
              according to the experience required.
            </p>
        ...
        <div className="about-image-block large">
          <img
            src={backgroundAbout}
            alt="Mistress Tabitha Thorne in an elegant private setting"
          />
        </div>
        ...
        <section className="about-section dark">
          ...
          <div className="grid">
            ...
            <div className="card">
              ...
              <p>
                Controlled tension, denied gratification, restrained allure.
              </p>
            </div>
