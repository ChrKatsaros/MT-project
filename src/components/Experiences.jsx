...
function Experiences() {
  return (
    <>
      ...
      <title>BDSM Experiences | Mistress Tabitha Thorne</title>

      <meta
        name="description"
        content="Explore private BDSM experiences with Mistress Tabitha Thorne, including psychological domination, power exchange, ritual, obedience and immersive luxury dynamics."
      />
      ...
      <link
        rel="canonical"
        href="https://www.tabithathorne.co.uk/experiences"
      />
      ...
      <meta
        property="og:title"
        content="BDSM Experiences | Mistress Tabitha Thorne"
      />

      <meta
        property="og:description"
        content="Explore psychological domination, ritual, obedience, power exchange and carefully curated private BDSM experiences with Mistress Tabitha Thorne."
      />

      <meta
        property="og:url"
        content="https://www.tabithathorne.co.uk/experiences"
      />
      ...
      <meta
        ...
        content="Explore psychological domination, ritual, obedience, power exchange and immersive private experiences with Mistress Tabitha Thorne."
      />
      ...
      <div className="experiences-page">
        ...
        <section className="exp-section">
          <p className="intro">
            Each experience is designed as a psychological atmosphere rather
            than a service. Nothing is transactional. Everything is intentional.
          </p>
        </section>
        ...
        <section className="exp-grid">
          ...
          <div className="exp-card">
            ...
            <p>
              Elevated environments where surrender becomes refined, curated,
              and guided through controlled atmosphere and presence.
            </p>
          </div>
          ...
          <div className="exp-card">
            ...
            <p>
              Hierarchical dynamics where control is gradually surrendered
              through trust, structure and guided anticipation.
            </p>
          </div>
        ...
        <section className="exp-featured-experiences">
          <div className="exp-featured-heading">
            ...
            <p>
              Two distinctive experiences created to extend the world of
              Mistress Tabitha beyond conventional domination.
            </p>
          </div>
        ...
        <section className="exp-section dark">
          ...
          <p>
            Private ABDL-oriented dynamics approached discreetly and
            respectfully, grounded in trust, structure, ritual and emotional
            awareness.
          </p>
